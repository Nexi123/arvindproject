  ...
  <body>
	 ...
	 <a href="empViewStatus" >View Status</a>		  
		 ...
		 <form action="findStatus" method="post" modelAttribute="status" >
								...
								<form action="submitEditStatus" modelAttribute="status" id="editStatusForm">
									Emp Id:<input value="${status1.empId}" name="empId" id="editStatusForm" />
									Date:<input value="${status1.date}" name="date" id="editStatusForm" />
					                Status:<input value="${status1.status}"  name="status" id="editStatusForm" />										
